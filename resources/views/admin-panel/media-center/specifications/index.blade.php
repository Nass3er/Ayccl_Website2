...
@section('title', __('adminlte::menu.specifications'))

@section('content_header')
    <h1>{{ __('adminlte::menu.specifications') }}</h1>
@stop
...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        <a href="{{ route('specifications.create', ['locale' => app()->getLocale()]) }}">
    ...
    @php
        ...
        foreach ($posts as $post) {
            ...
            $btnEdit =
                '<a href="' .
                route('specifications.edit', ['specification' => $post->id, 'locale' => app()->getLocale()]) .
    ...
    <script>
        $(document).ready(function() {
            $('#modalCustom').on('show.bs.modal', function(event) {
                ...
                var deleteAction =
                    '{{ route('specifications.destroy', ['locale' => app()->getLocale(), 'specification' => '__ID__']) }}';
