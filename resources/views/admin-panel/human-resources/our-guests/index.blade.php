...
@section('title', __('adminlte::menu.ourGuests'))

@section('content_header')
    <h1>{{ __('adminlte::menu.ourGuests') }}</h1>
@stop
...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        <a href="{{ route('our-guests.create', ['locale'=> app()->getLocale()]) }}">
    ...
    @php
        ...
        foreach ($posts as $post) {
            ...
            $btnEdit =
                '<a href="' .
                route('our-guests.edit', ['our_guest' => $post->id, 'locale' => app()->getLocale()]) .
    ...
    <script>
        $(document).ready(function() {
            $('#modalCustom').on('show.bs.modal', function(event) {
                ...
                var deleteAction =
                    '{{ route('our-guests.destroy', ['locale' => app()->getLocale(), 'our_guest' => '__ID__']) }}';
