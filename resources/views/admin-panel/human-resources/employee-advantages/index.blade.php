...
@section('title', __('adminlte::menu.employeeAdvantages'))

@section('content_header')
    <h1>{{ __('adminlte::menu.employeeAdvantages') }}</h1>
@stop
...
@section('content')
    ...
    //       
        ...
        $config = [
            ...
            // 'serverSide' => true,
            // 'processing' => true,
            // 'ajax' => "{{ localizedRoute('employeeAdvantages.index') }}",
            'language' => [
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modalActivate').on('show.bs.modal', function(event) {
                ...
                // Assuming 'employeeAdvantages.activate' is a route for activating employeeAdvantages. Adjust as needed.
                var action =
