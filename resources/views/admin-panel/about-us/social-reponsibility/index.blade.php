...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        <a href="{{ route('social-reponsibility.create', ['locale', app()->getLocale()]) }}">
    ...
    @php
        ...
        foreach ($posts as $post) {
            ...
            $btnEdit =
                '<a href="' .
                route('social-reponsibility.edit', ['social_reponsibility' => $post->id, 'locale' => app()->getLocale()]) .
    ...
    <script>
        $(document).ready(function() {
            $('#modalCustom').on('show.bs.modal', function(event) {
                ...
                var deleteAction =
                    '{{ route('social-reponsibility.destroy', ['locale' => app()->getLocale(), 'social_reponsibility' => '__ID__']) }}';
