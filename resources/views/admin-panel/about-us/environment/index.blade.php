...
@section('title', __('adminlte::menu.environment'))

@section('content_header')
    <h1>{{ __('adminlte::menu.environment') }}</h1>
@stop
...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        <a href="{{ route('environments.create', ['locale', app()->getLocale()]) }}">
    ...
    @php
        ...
        foreach ($posts as $post) {
            ...
            $btnEdit =
                '<a href="' .
                route('environments.edit', ['environment' => $post->id, 'locale' => app()->getLocale()]) .
    ...
    <script>
        $(document).ready(function() {
            $('#modalCustom').on('show.bs.modal', function(event) {
                ...
                var deleteAction =
                    '{{ route('environments.destroy', ['locale' => app()->getLocale(), 'environment' => '__ID__']) }}';
