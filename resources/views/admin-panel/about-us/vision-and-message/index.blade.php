...
@section('title', __('adminlte::adminlte.visionAndMessage'))

@section('content_header')
    <h1>{{ __('adminlte::adminlte.visionAndMessage') }}</h1>
@stop
...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        {{-- <a href="{{ route('vision-and-message.create', ['locale'=> app()->getLocale()]) }}">
    ...
    @php
        ...
        foreach ($posts as $post) {
            ...
            $btnEdit =
                '<a href="' .
                route('vision-and-message.edit', ['vision_and_message' => $post->id, 'locale' => app()->getLocale()]) .
        ...
        $config = [
            ...
            // 'serverSide' => true,
            // 'processing' => true,
            // 'ajax' => "{{ localizedRoute('vision-and-message.index') }}",
            'language' => [
    ...
    <script>
        $(document).ready(function() {
            $('#modalCustom').on('show.bs.modal', function(event) {
                ...
                var deleteAction =
                    '{{ route('vision-and-message.destroy', ['locale' => app()->getLocale(), 'vision_and_message' => '__ID__']) }}';
            ...
            $('#modalActivate').on('show.bs.modal', function(event) {
                ...
                // Assuming 'vision-and-message.activate' is a route for activating vision-and-message. Adjust as needed.
                var action =
