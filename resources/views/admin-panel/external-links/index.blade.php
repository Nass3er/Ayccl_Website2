...
@section('content')
    ...
    <div class="container mx-0  mb-5">
        <a href="{{ route("$route.create", ['locale'=> app()->getLocale()]) }}">
            <x-adminlte-button class="btn-lg mb-10" type="reset" label="{{ __('adminlte::adminlte.createNewSocialMediaIcon') }}"
    ...
    @php
        $heads = [
            ...
            ['label' => __('adminlte::adminlte.value'), 'classes' => 'border border-white bg-olive'],
            ['label' => __('adminlte::adminlte.category'), 'classes' => 'border border-white bg-olive','no-export' => true,
                'width' => 13,],
            [
        ...
        foreach ($posts as $post) {
            ...
            $btnActivation =
                ...
                // __('adminlte::adminlte.activate') .
                '</a></span>';
                $category = $post->category_id==13? '<a class="btn btn-info" >'.$post->category->name.'</a>': $post->category->name;
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modalActivate').on('show.bs.modal', function(event) {
                ...
                // Assuming 'products.activate' is a route for activating products. Adjust as needed.
                var action =
