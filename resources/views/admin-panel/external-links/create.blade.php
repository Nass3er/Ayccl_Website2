...
@section('title', __("adminlte::$pageName") .' - '. __('adminlte::adminlte.createNewSocialMediaIcon'))
...
@section('content_header')
    <div class="row">
        <ol class="breadcrumb float-sm-left">
            ...
            <li class="breadcrumb-item active">{{ __('adminlte::adminlte.createNewSocialMediaIcon') }}</li>
        </ol>
    </div>
@stop
            ...
            <div class="card-body">
                ...
                <div class="form-group col-12 col-md-6">
                    <x-adminlte-input-file-krajee name="files"
                        label="{{ __('adminlte::adminlte.attachmentsUpload') . ' (' . __('adminlte::adminlte.image').' - '. __('adminlte::adminlte.betterBeSvg') . ')' }}"
                        data-msg-placeholder="Choose a text, office or pdf file..." label-class="text-olive"
                        :config="$config" />
                    <p class="text-left">{{  __('adminlte::adminlte.svgSuggestion')  }} <a href="https://www.svgviewer.dev/">https://www.svgviewer.dev</a> </p>
                </div>
                </div>
